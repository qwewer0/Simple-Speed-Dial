...
function createDefaults() {
	var default_values = {
		...
		thumbnailing_service: "http://api.miniature.io/?width=500&height=400&screen=1280&url=[URL]"
	};
	...
	if (localStorage.getItem("thumbnailing_service").indexOf("immediatenet.com") > 0) {
		localStorage.setItem("thumbnailing_service", "http://api.miniature.io/?width=500&height=400&screen=1280&url=[URL]");
	}
}
